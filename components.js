 ...
 * najarriyadih.com — v3 unified (about, reviews, blog integrated)
 */
...
/* ═══════════════════════════════════════════
   PATH HELPER — works from root & /blog/
═══════════════════════════════════════════ */
...
const translations = {
  ar: {
    dir: 'rtl', lang: 'ar',
    langBtnLabel: 'EN', langBtnFull: 'English', langBtnAria: 'Switch to English',
    ...
    aboutLabel: 'من نحن', aboutTitle1: 'حرفة توارثناها', aboutTitle2: 'وطوّرناها',
    ...
    servicesLabel: 'ماذا نقدّم', servicesTitle: 'خدماتنا المتميزة',
    servicesSubtitle: 'من الفكرة إلى التنفيذ — نغطي كل احتياجاتك الخشبية في الرياض',
    svc1Title: 'أثاث مخصص', svc1Text: 'نصمّم ونصنع أثاثًا يعكس شخصيتك — من غرف النوم إلى الصالات والمكاتب، كل قطعة تُصنع خصيصًا لك.',
    svc2Title: 'تركيب المطابخ', svc2Text: 'مطابخ فاخرة بتصاميم عصرية وكلاسيكية — وحدات تخزين ذكية وتشطيبات راقية تدوم طويلًا.',
    svc3Title: 'أبواب وأعمال خشبية', svc3Text: 'أبواب داخلية وخارجية بأحجام وتصاميم متنوعة — نقوش يدوية وتشطيبات احترافية تُضيف هيبةً لمدخلك.',
    svc4Title: 'صيانة وإصلاح', svc4Text: 'الأعمال الخشبية تحتاج عناية — نقدم خدمات الإصلاح والتجديد لإعادة الأثاث لرونقه الأول بأسرع وقت.',
    learnMore: 'اعرف أكثر',
    galleryLabel: 'أعمالنا', galleryTitle: 'معرض المشاريع',
    ...
    whyLabel: 'لماذا نحن', whyTitle: 'ما يميّز', whyTitleEm: 'نجار الرياض',
    ...
    contactLabel: 'تواصل معنا', contactTitle: 'نحن هنا لخدمتك',
    contactSubtitle: 'تواصل معنا اليوم واحصل على استشارة مجانية وعرض سعر فوري',
    contactPhone: 'الهاتف', contactWa: 'واتساب', contactWaLink: 'راسلنا على واتساب',
    ...
    formSubmit: 'إرسال الرسالة', formSending: 'جاري الإرسال...',
    ...
    footerQuickLinks: 'روابط سريعة', footerServices: 'خدماتنا', footerContact: 'تواصل معنا',
    footerHome: 'الرئيسية', footerAbout: 'من نحن', footerReviews: 'آراء العملاء',
    footerBlog: 'المدونة', footerGallery: 'معرض الأعمال', footerContactLink: 'تواصل معنا',
    footerLocation: 'الرياض، المملكة العربية السعودية',
    footerHours: 'السبت–الخميس: ٨ص–٩م', footerRights: 'جميع الحقوق محفوظة.',
    ariaInstagram: 'إنستغرام', ariaSnapchat: 'سناب شات', ariaTiktok: 'تيك توك', ariaWhatsapp: 'واتساب',
  },
  en: {
    dir: 'ltr', lang: 'en',
    langBtnLabel: 'عر', langBtnFull: 'العربية', langBtnAria: 'Switch to Arabic',
    siteName: 'Mina Carpentry',
    pageTitle: 'Mina Carpentry | Custom Furniture, Kitchens, Doors — najarriyadih.com',
    ...
    navGallery: 'Portfolio', navReviews: 'Reviews', navBlog: 'Blog', navContact: 'Contact',
    ...
    heroCtaWa: 'Chat with us on WhatsApp', heroCtaServices: 'Explore Our Services',
    ...
    aboutSince: 'Since 2004', aboutBadge: 'Top Rated<br/>in Riyadh',
    aboutLabel: 'Who We Are', aboutTitle1: 'A Craft We Inherited', aboutTitle2: 'and Perfected',
    aboutP1: 'Since 2004, we have delivered more than 600 carpentry projects across Riyadh. We transform every piece of wood into a work of art that beautifies homes and offices.',
    aboutP2: 'Our team of skilled craftsmen blends tradition with modernity — we use the finest imported woods and latest techniques to deliver a product worthy of you.',
    ...
    servicesLabel: 'What We Offer', servicesTitle: 'Our Premium Services',
    servicesSubtitle: 'From concept to completion — covering all your woodwork needs in Riyadh',
    svc1Title: 'Custom Furniture', svc1Text: 'We design and craft furniture that reflects your personality — every piece made exclusively for you.',
    svc2Title: 'Kitchen Installation', svc2Text: 'Luxury kitchens in modern and classic designs — smart storage units and elegant finishes.',
    svc3Title: 'Doors & Woodwork', svc3Text: 'Interior and exterior doors with hand carvings and professional finishes.',
    svc4Title: 'Maintenance & Repair', svc4Text: 'We offer repair and restoration services to bring your furniture back to its former glory.',
    learnMore: 'Learn More',
    galleryLabel: 'Our Work', galleryTitle: 'Project Portfolio',
    gallerySubtitle: 'Selected samples from our completed projects in Riyadh',
    ...
    whyLabel: 'Why Us', whyTitle: 'What Sets', whyTitleEm: 'Riyadh Carpenter Apart',
    ...
    whyCard2Text: "Quality doesn't mean expensive — transparent, competitive prices with no hidden fees.",
    whyNum3: '03', whyCard3Title: 'Fast Turnaround',
    whyCard3Text: 'We respect your time and honor deadlines. Clear timeline from day one.',
    whyNum4: '04', whyCard4Title: 'Full Warranty',
    whyCard4Text: 'Full warranty on all our products and follow-up maintenance service.',
    ...
    contactPhone: 'Phone', contactWa: 'WhatsApp', contactWaLink: 'Message us on WhatsApp',
    ...
    formName: 'Full Name', formNamePh: 'Enter your full name', formPhone: 'Mobile Number',
    ...
    formSubmit: 'Send Message', formSending: 'Sending...',
    formSuccessMsg: 'Your message was sent successfully! We will contact you shortly.',
    footerTagline: 'Professional carpentry in Riyadh — furniture, kitchens, doors, and maintenance. 20 years at your service.',
    footerWaLink: 'Message us on WhatsApp',
    footerQuickLinks: 'Quick Links', footerServices: 'Our Services', footerContact: 'Contact',
    footerHome: 'Home', footerAbout: 'About Us', footerReviews: 'Reviews',
    footerBlog: 'Blog', footerGallery: 'Portfolio', footerContactLink: 'Contact Us',
    footerLocation: 'Riyadh, Saudi Arabia', footerHours: 'Sat–Thu: 8 AM–9 PM',
    footerRights: 'All rights reserved.',
    ariaInstagram: 'Instagram', ariaSnapchat: 'Snapchat', ariaTiktok: 'TikTok', ariaWhatsapp: 'WhatsApp',
  }
};
...
function renderHeader(activePage) {
  ...
  const links = [
    { id: 'home',     href: base + 'index.html',          labelKey: 'navHome',     icon: 'fas fa-home'      },
    { id: 'about',    href: base + 'about.html',           labelKey: 'navAbout',    icon: 'fas fa-users'     },
    { id: 'services', href: base + 'index.html#services',  labelKey: 'navServices', icon: 'fas fa-hammer'    },
    { id: 'gallery',  href: base + 'index.html#gallery',   labelKey: 'navGallery',  icon: 'fas fa-images'    },
    { id: 'reviews',  href: base + 'reviews.html',         labelKey: 'navReviews',  icon: 'fas fa-star'      },
    { id: 'blog',     href: base + 'blog.html',            labelKey: 'navBlog',     icon: 'fas fa-book-open' },
    { id: 'contact',  href: base + 'index.html#contact',   labelKey: 'navContact',  icon: 'fas fa-phone-alt' },
  ];

  const nav = links.map(l =>
    `<li>
      <a href="${l.href}" class="nav__link${activePage === l.id ? ' active' : ''}" data-i18n="${l.labelKey}">
        <i class="${l.icon} nav__link-icon"></i>
        <span>${t(l.labelKey)}</span>
      </a>
    </li>`
  ).join('');

  const logoSrc = base + 'na.png';

  document.getElementById('site-header').innerHTML = `
    <nav class="nav container">
      <a href="${base}index.html" class="nav__logo" aria-label="${t('siteName')}">
        <img src="${logoSrc}" alt="${t('siteName')}" class="nav__logo-img"
      ...
      <div class="nav__drawer" id="navDrawer">
        <div class="nav__drawer-header">
          <span class="nav__logo-text" style="color:var(--g300);font-size:1.1rem">${t('siteName')}</span>
          <button class="nav__close" id="navClose" type="button" aria-label="إغلاق القائمة">
            <i class="fas fa-times"></i>
          </button>
        </div>
        <ul class="nav__drawer-menu" role="navigation" aria-label="${t('navMenuAria')}">
          ${links.map(l => `
            <li>
              <a href="${l.href}" class="nav__drawer-link${activePage === l.id ? ' active' : ''}">
                <i class="${l.icon}"></i>
                <span data-i18n="${l.labelKey}">${t(l.labelKey)}</span>
              </a>
            </li>`).join('')}
        </ul>
        <div class="nav__drawer-ctas">
          <a href="tel:0${PHONE}" class="btn btn--primary btn--full">
            <i class="fas fa-phone"></i> <span data-i18n="navCall">${t('navCall')}</span>
          </a>
          <a href="https://wa.me/${WA_NUM}" class="btn btn--gold btn--full" target="_blank" rel="noopener">
            <i class="fab fa-whatsapp"></i> <span data-i18n="navWa">${t('navWa')}</span>
          </a>
        </div>
        <div class="nav__drawer-footer">
          <a href="https://wa.me/${WA_NUM}" target="_blank" rel="noopener" aria-label="WhatsApp"><i class="fab fa-whatsapp"></i></a>
      ...
      <div class="nav__actions">
        ...
        <a href="https://wa.me/${WA_NUM}" class="btn btn--whatsapp" target="_blank" rel="noopener">
          <i class="fab fa-whatsapp" style="font-size:1rem"></i>
          <span data-i18n="navWa">${t('navWa')}</span>
        </a>
        <div class="lang-switcher" id="langSwitcher">
          <button class="lang-switcher__btn" id="langBtn" type="button"
            aria-haspopup="listbox" aria-expanded="false" aria-label="${t('langBtnAria')}">
          ...
          <div class="lang-switcher__dropdown" id="langDropdown" role="listbox" aria-label="Language">
            <button class="lang-switcher__option${currentLang === 'ar' ? ' active' : ''}" role="option"
              aria-selected="${currentLang === 'ar'}" data-lang="ar" type="button">
              <span class="lang-flag" aria-hidden="true">🇸🇦</span><span>العربية</span><span class="check" aria-hidden="true">✓</span>
            </button>
            <button class="lang-switcher__option${currentLang === 'en' ? ' active' : ''}" role="option"
              aria-selected="${currentLang === 'en'}" data-lang="en" type="button">
              <span class="lang-flag" aria-hidden="true">🇬🇧</span><span>English</span><span class="check" aria-hidden="true">✓</span>
            </button>
          </div>
        </div>
        <button class="nav__hamburger" id="hamburger" type="button"
          aria-label="${t('navMenuAria')}" aria-expanded="false" aria-controls="navDrawer">
    ...
    <div class="container">
      <div class="footer__grid">
        <div class="footer__brand">
          <a href="${base}index.html" class="nav__logo" style="display:inline-flex;margin-bottom:.75rem">
            <img src="${base}na.png" alt="${t('siteName')}" class="nav__logo-img" style="height:40px"
              onerror="this.style.display='none';this.nextElementSibling.style.display='flex'"/>
          ...
          <div class="footer__contact-quick">
            ...
            <a href="https://wa.me/${WA_NUM}" target="_blank" rel="noopener">
              <i class="fab fa-whatsapp"></i> <span data-i18n="footerWaLink">${t('footerWaLink')}</span>
            </a>
          </div>
        ...
        <div class="footer__links">
          ...
          <ul>
            <li><a href="${base}index.html"><i class="fas fa-chevron-left"></i><span data-i18n="footerHome">${t('footerHome')}</span></a></li>
            <li><a href="${base}about.html"><i class="fas fa-chevron-left"></i><span data-i18n="footerAbout">${t('footerAbout')}</span></a></li>
            <li><a href="${base}reviews.html"><i class="fas fa-chevron-left"></i><span data-i18n="footerReviews">${t('footerReviews')}</span></a></li>
            <li><a href="${base}blog.html"><i class="fas fa-chevron-left"></i><span data-i18n="footerBlog">${t('footerBlog')}</span></a></li>
            <li><a href="${base}index.html#gallery"><i class="fas fa-chevron-left"></i><span data-i18n="footerGallery">${t('footerGallery')}</span></a></li>
            <li><a href="${base}index.html#contact"><i class="fas fa-chevron-left"></i><span data-i18n="footerContactLink">${t('footerContactLink')}</span></a></li>
          </ul>
        </div>
        ...
        <div class="footer__links">
          ...
          <ul>
            <li><a href="${base}index.html#services"><i class="fas fa-couch"></i><span data-i18n="svc1Title">${t('svc1Title')}</span></a></li>
            <li><a href="${base}index.html#services"><i class="fas fa-utensils"></i><span data-i18n="svc2Title">${t('svc2Title')}</span></a></li>
            <li><a href="${base}index.html#services"><i class="fas fa-door-open"></i><span data-i18n="svc3Title">${t('svc3Title')}</span></a></li>
            <li><a href="${base}index.html#services"><i class="fas fa-tools"></i><span data-i18n="svc4Title">${t('svc4Title')}</span></a></li>
          </ul>
        </div>
...
function applyTranslations() {
  ...
  document.querySelectorAll('[data-i18n]').forEach(el => {
    ...
    if (attrTarget) { el.setAttribute(attrTarget, val); }
    else { el[val.includes('<br') ? 'innerHTML' : 'textContent'] = val; }
  });
  ...
  // Fix footer chevron for LTR
  document.querySelectorAll('.footer__links .fa-chevron-left').forEach(icon => {
    if (tr.dir === 'ltr') icon.classList.replace('fa-chevron-left', 'fa-chevron-right');
  });
}
...
function switchLanguage(lang) {
  ...
  setTimeout(() => {
    ...
    renderHeader(activePage); renderFooter(); renderFloats();
    applyTranslations(); bindHeaderEvents(); bindLangSwitcher(); bindBackToTop();
...
function bindLangSwitcher() {
  ...
  const openDD  = () => { langDropdownOpen = true;  langDropdown.classList.add('open');    newBtn.setAttribute('aria-expanded','true'); };
  const closeDD = () => { langDropdownOpen = false; langDropdown.classList.remove('open'); newBtn.setAttribute('aria-expanded','false'); };

  newBtn.addEventListener('click', e => { e.stopPropagation(); langDropdownOpen ? closeDD() : openDD(); });
  langDropdown.querySelectorAll('.lang-switcher__option').forEach(opt => {
    opt.addEventListener('click', e => { e.stopPropagation(); switchLanguage(opt.dataset.lang); closeDD(); });
  });
  const outside = e => { const s = document.getElementById('langSwitcher'); if (s && !s.contains(e.target)) closeDD(); };
...
function bindHeaderEvents() {
  ...
  // Desktop nav: close drawer if somehow open
